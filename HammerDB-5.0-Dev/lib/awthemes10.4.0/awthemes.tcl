...
namespace eval ::ttk::awthemes {
  ...
  proc _createTreeview { {pfx {}} {sfx {}} {scale 1.0} } {
    ...
    if { $vars(have.tksvg) && [info exists images(tree-arrow-down-n)] } {
      ...
      # Bug with Default Tk 9 where all treeview images show same indicator 
      # user1 and user2 have been redefined to be open and leaf
      # Bug is fixed in HammerDB by modifying ttkTreeview.c and ttkDefaultTheme.c
      # in Tk source and re-add the following from Tk 8.6
