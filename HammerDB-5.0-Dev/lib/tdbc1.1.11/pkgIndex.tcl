...
apply {{dir} {
	...
	package ifneeded tdbc 1.1.11 \
		"package require TclOO;\
		[list load [file join $dir libtcl9tdbc1.1.11.so] [string totitle tdbc]]\;\
		[list source -encoding utf-8 $libraryfile]"
    } else {
	package ifneeded tdbc 1.1.11 \
		"package require TclOO;\
		[list load [file join $dir libtdbc1.1.11.so] [string totitle tdbc]]\;\
		[list source -encoding utf-8 $libraryfile]"
    }
}} $dir
